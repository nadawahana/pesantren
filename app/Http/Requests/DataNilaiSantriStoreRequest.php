...
class DataNilaiSantriStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'baca_alquran'  => 'required|numeric|min:0|max:100',
            'sholat'  => 'required|numeric|min:0|max:100',
            'tahfidz'  => 'required|numeric|min:0|max:100',
            'ujian_tulisan'  => 'required|numeric|min:0|max:100',
