...
@if(session('message'))
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Silahkan <a href="/inputdaftar"> <span class="text-primary" type="submit">Klik disini!</span></a> untuk pembayaran pendaftaran</h6>
                </div>
 ...
 <div class="col-md-12 grid-margin stretch-card">
              <script>
                fetch('http://127.0.0.1:8000/api/data-gelombang2')
                    ...
                    .then(data => {
                      ...
                      document.getElementById('bts_wkt1').value = bts_wkt;
                      document.getElementById('u_l1').value = u_l;
                      document.getElementById('u_t1').value = u_t;
                      document.getElementById('p_h1').value = p_h;
                      document.getElementById('d_u1').value = d_u;
