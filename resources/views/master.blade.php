        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <a class="nav-link" href="/userhome">
              ...
              <span class="menu-title">Home</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/informasi-pendaftaran" aria-expanded="false"
                            aria-controls="icons">
                            <i class="icon-columns menu-icon"></i>
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/inputdaftar">Form Pendaftaran</a></li>
              </ul>
            </div>
          </li> -->
                    <li class="nav-item">
                        <a class="nav-link" href="/inputdaftar" aria-expanded="false" aria-controls="icons">
                            <i class="icon-bar-graph menu-icon"></i>
                            <span class="menu-title">Pendaftaran</span>
                        </a>
                    </li>
