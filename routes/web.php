...
Route::get('/userdatadaftar', 'user@userdatadaftar');
Route::get('/persyaratan', 'user@persyaratan'); //udah
...
Route::get('/data-ortu', 'DataOrtuController@get');
Route::get('/statusKelulusan', 'DataDiriController@statusKelulusan');
